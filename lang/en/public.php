...
return [
    ...
    "broker_capital" => "Broker Capital",
    "master_password" => "Master Password",
    "account_loading_caption" => "Loading accounts data. Please wait.",
    "no_accounts" => "No Accounts Found",
    "total_broker_capital" => "Total Broker Capital",
    ...
    "linked" => "Linked",
    "unlink" => "Unlink",
    "toast_approve_account_success" => "Successfully Approved Account",
    "toast_reject_account_success" => "Successfully Rejected Account",
