...
return [
    ...
    "pending_account" => "待处理账户",
    "broker_capital" => "经纪商资金",
    "master_password" => "主密码",
    "account_loading_caption" => "正在加载账户数据，请稍候。",
    "no_accounts" => "未找到账户。",
    "total_broker_capital" => "经纪商总资金",
    "total_accounts" => "账户总数",
    "view_account" => "查看账户",
    "account_proof" => "账户证明",
    "reject_account" => "拒绝账户",
    "approve_account" => "批准账户",
    "linked" => "已链接",
    "unlink" => "未连接",
    "toast_approve_account_success" => "成功批准账户",
    "toast_reject_account_success" => "成功拒绝账户",
    "view_connection" => "查看连接",
    "reject_connection" => "拒绝连接",
    "approve_connection" => "批准连接",
