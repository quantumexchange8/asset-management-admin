                    ...
                    <div class="flex items-end gap-1">
                        <div class="flex flex-col items-start gap-2">
                            <div class="text-surface-500 text-sm">
                                {{ $t('public.total_pending_fund') }}
                            </div>
                            <div class="text-3xl font-semibold">
                                <div v-if="totalPendingFund === null">
            ...
            <template #content>
                <div class="flex justify-between items-center">
                    <div class="flex items-end gap-1">
                        <div class="flex flex-col items-start gap-2">
                            <div class="text-surface-500 text-sm">
                                {{ $t('public.total_pending_connections') }}
                            </div>
                            <div class="text-3xl font-semibold">
                                <div v-if="totalPendingConnections === null">
                                    <Skeleton width="5rem" class="my-0.5" height="2rem"></Skeleton>
                                </div>

                                <div v-else>
                                    {{ formatAmount(totalPendingConnections, 0) }}
                                </div>
                            </div>
                        </div>
                    </div>
