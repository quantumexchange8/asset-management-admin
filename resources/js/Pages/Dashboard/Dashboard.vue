...
import DashboardPayout from "@/Pages/Dashboard/DashboardPayout.vue";

const props = defineProps({
    totalActiveFund: String
});
    ...
    <AuthenticatedLayout title="dashboard">
        <div class="flex flex-col gap-5 items-center self-stretch">
            ...
            <div class="flex flex-col xl:flex-row gap-5 items-center self-stretch w-full">
                ...
                <div class="flex flex-col gap-3 w-full md:max-w-[380px] xl:max-w-[420px]">
                    <DashboardPayout />
                </div>
            </div>
        </div>
